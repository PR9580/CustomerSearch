...
public class CustomerControllerTest {
	...
	public void testgetAllCustomersSuccess() {
		...
		when(customerService.getAllCustomers(any(HttpServletRequest.class))) .thenReturn(new GenericResponse(200,
		...
		verify(customerService, times(1)).getAllCustomers(mockRequest);
